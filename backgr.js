...
const button15 = document.getElementById('butn15');
button15.addEventListener('click', function() {
  obnuleniefon();
  obnulenie2();
  document.getElementById("prim15").style.display = "block";
  this.style.color = 'blue';
});
const button16 = document.getElementById('butn16');
button16.addEventListener('click', function() {
  obnuleniefon();
  obnulenie2();
  document.getElementById("prim16").style.display = "block";
  this.style.color = 'blue';
});
const button17 = document.getElementById('butn17');
button17.addEventListener('click', function() {
  obnuleniefon();
  obnulenie2();
  document.getElementById("prim17").style.display = "block";
  this.style.color = 'blue';
});
const button18 = document.getElementById('butn18');
button18.addEventListener('click', function() {
  obnuleniefon();
  obnulenie2();
  document.getElementById("prim18").style.display = "block";
  this.style.color = 'blue';
});
const button19 = document.getElementById('butn19');
button19.addEventListener('click', function() {
  obnuleniefon();
  obnulenie2();
  document.getElementById("prim19").style.display = "block";
  this.style.color = 'blue';
});
...
var obnuleniefon = function(){
  ...
  document.getElementById("prim16").style.display = "none";  
  document.getElementById("prim17").style.display = "none";  
  document.getElementById("prim18").style.display = "none";  
  document.getElementById("prim19").style.display = "none";  
}
var obnulenie2 = function(){
  ...
  button15.style.color = 'red';
  button16.style.color = 'red';
  button17.style.color = 'red';
  button18.style.color = 'red';
  button19.style.color = 'red';
}
